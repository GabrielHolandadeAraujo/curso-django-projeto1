...
class Tag(models.Model):
    ...
    # esse cascade serve para aplicar algo em cascata, exemplo deletar todos os comentário em uma receita quando
    #  a receita for apagada. Mais ver aula 245 (modulo 20)
